...
public class JWTHeaderToProperties implements Callable{
	
	private static Logger logger = LogManager.getLogger(JWTHeaderToProperties.class.getName());
	...
	public Object onCall(MuleEventContext eventContext) throws WaveMoneyJWTException {
		...
		logger.info("=== JWT Header To Properties ===");
		 
		JwtClaims jwtClaims = ju.validateJWEAndReturnClaims((String)eventContext.getMessage().getInboundProperty("wmt-mfs"));
